...
| 文件 | 目的 |
|------|------|
| `app.json` | 声明应用名、包名 `com.pppxxxy.easychat2`、暗色主题、Android 读媒体权限与 EAS projectId；`icon` / `splash` / `android.adaptiveIcon` 指向 `assets/` 下的 1024×1024 资源，自适应图标前景主体位于中央 66% 安全区、背景色 `#1a1a2e` |
