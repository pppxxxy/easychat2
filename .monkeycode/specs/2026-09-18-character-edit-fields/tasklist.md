...
- [x] 1. 数据模型
  - [x] 1.1 `DEFAULT_CHARACTER` 与 `normalizeCharacter` 新增 `alternateGreetings`、`mesExample`（需求 4.1、4.2）
  - [x] 1.2 `cardParser` 读取 `alternate_greetings`（需求 4.3）
  - [x] 1.3 `cardExporter` 写出 `alternate_greetings`（需求 4.3）
