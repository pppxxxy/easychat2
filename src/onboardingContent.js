...
export const ONBOARDING_CHAPTERS = [
  ...
  },
  {
    ...
    intro: '用户人设是你在对话中的身份。这里的信息会注入到提示词中，角色的正则脚本也可以通过 {{user}} 引用你的名字。头像为全部人设共用。',
    steps: [
      '打开「设置」，找到「用户人设」卡片。',
    ...
    items: [
      ...
      { name: '共用头像', where: '设置 → 用户人设', usage: '头像为全部人设共用，不随人设切换。' },
    ],
  ...
  },
  {
    ...
    disclaimer: '本教程仅提供技术信息，不对任何第三方平台的内容合法性及安全性做出保证。关于第三方平台的内容合法性及安全性，本教程已提前向用户做出明确警告。用户应自行承担使用第三方平台的全部风险。',
    ...
    outro: {
      title: '进阶工具：Nika-Character-Studio',
      body: '如果你找不到满意的现成角色卡，或者想根据喜欢的小说、设定自己动手制作，推荐尝试这个开源项目：Nika-Character-Studio（作者：HiUnikitty）。该项目是一个完全在本地运行的 AI 角色卡编辑器，数据不上传服务器，主要功能包括：',
      bullets: [
        '小说转世界书系统：将小说文本一键转换为角色卡的世界书设定。',
        'AI 一键补全：辅助生成角色描述、性格、对话示例。',
        '世界书生成：自动生成角色书条目，支持 AI 协助。',
        '一键翻译：将英文角色卡快速翻译为中文。',
        '交互式变量卡：制作带生命值、金币、背包等 UI 的互动冒险角色卡。',
      ],
      link: { label: '项目地址：Nika-Character-Studio', url: 'https://github.com/HiUnikitty/Nika-Character-Studio' },
      linkNotice: '该工具为本地开源软件，不提供任何预置角色卡内容。用户使用其创作并传播的内容，请自行确保不侵犯第三方版权。',
      disclaimer: '本教程仅提供技术信息，不对该开源项目的功能完整性及由其生成内容的版权、合法性做出保证。关于第三方工具及内容的安全性，本教程已提前向用户做出明确警告。用户应自行承担使用该工具及后续内容的全部风险。',
    },
  ...
  },
  {
    ...
    image: 'chat-ui',
    images: [
      { key: 'chat-ui', caption: '聊天对话：消息气泡与操作行。' },
  ...
  },
  {
    ...
    images: [
      ...
      { key: 'character-edit', caption: '编辑表单：标签、保存，以及世界书 / 正则 / 全局预设入口。' },
    ],
  ...
  },
  {
    ...
    icon: 'images-outline',
    image: 'moments',
    summary: '让角色发布动态，评论会得到角色基于那段记忆的回复。',
    intro: '动态会根据聊天进展让角色发布内容，你可以点赞、评论。评论后角色会结合这条动态来源的那段对话记忆回复你——这段互动相当于一次对话，但不会写进聊天记录，也不会进入记忆。',
    steps: [
      '在扩展页进入动态视图，查看角色发布的内容。',
      '在设置中开启或关闭动态功能。',
      '对动态点赞或评论，互动会记录到好感度中。',
      '评论后角色会依据该动态对应的记忆回复，可在同一条动态下继续聊。',
      '点击动态可查看完整内容，长按或使用操作按钮可删除。',
    ],
    items: [
      { name: '查看动态', where: '扩展 → 动态', usage: '以时间线形式展示角色发布的内容。' },
      { name: '开启与设置', where: '设置 → 动态', usage: '开启或关闭动态功能。' },
      { name: '点赞 / 评论', where: '动态下方操作', usage: '参与互动，会累计好感度；评论后角色会依据该动态来源的记忆回复。' },
      { name: '删除动态', where: '动态的操作按钮', usage: '删除单条动态，需二次确认。' },
      { name: '删除记忆时的联动', where: '记忆删除 / 删除角色并连删记忆', usage: '若这些记忆对应了动态，会提示是否一起删除。' },
    ],
    note: '动态内容由模型生成，可能存在与设定不符的情况，可随时删除。动态下的评论交流不会写入聊天记录或记忆。',
  },
  {
    id: 'vector-api',
    title: '向量 API 获取与设置',
