...
const createChatStyles = (theme, fonts, tokens) => StyleSheet.create({
  ...
  characterAvatar: { width: 26, height: 26, borderRadius: tokens.radius.pill, marginRight: tokens.spacing.sm, borderWidth: tokens.border.thin, borderColor: 'rgba(139,133,255,0.35)' },
  ...
  modalRowActive: { borderWidth: tokens.border.thin, borderColor: theme.colors.primary, backgroundColor: 'rgba(108,99,255,0.16)' },
